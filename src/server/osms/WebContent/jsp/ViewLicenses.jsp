...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" BGCOLOR="#FFFFFF">
	...
	<TR>
		...
		<TD WIDTH="207"><IMG SRC="images/open_ipmp_manage_39.jpg" WIDTH="207" HEIGHT="70" ALIGN="BOTTOM"
			BORDER="0"></TD>
		<TD WIDTH="390" VALIGN="TOP" background="key.gif">
		<IMG SRC="spacer.gif" WIDTH="390" HEIGHT="15" ALIGN="BOTTOM" BORDER="0"><BR><IMG SRC="spacer.gif" WIDTH="63" HEIGHT="15" ALIGN="BOTTOM"
		BORDER="0"><IMG SRC="arrow_off.gif" WIDTH="12" HEIGHT="13" ALIGN="BOTTOM" BORDER="0"><A HREF="UserKeyStore.jsp?date=<%= Global.getTime() %>" CLASS="nav">Keystore</A>
		<IMG SRC="spacer.gif" WIDTH="35" HEIGHT="15" ALIGN="BOTTOM" BORDER="0"><IMG SRC="arrow_off.gif" WIDTH="12" HEIGHT="13" ALIGN="BOTTOM" BORDER="0">
		<A HREF="registeredContent.jsp?date=<%= Global.getTime() %>" CLASS="nav">Content</A><IMG SRC="spacer.gif" WIDTH="35" HEIGHT="15" ALIGN="BOTTOM" BORDER="0">
		<IMG SRC="arrow_on.gif" WIDTH="12" HEIGHT="13" ALIGN="BOTTOM" BORDER="0"><FONT CLASS="nav_on">Licenses</FONT></TD>
		...
		<TD VALIGN="TOP" COLSPAN="3" BGCOLOR="#FFFFFF">
			<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="686">
				...
				<TR>
					...
					<TD WIDTH="655"><IMG SRC="licenses.gif" WIDTH="268" HEIGHT="23" ALIGN="BOTTOM" BORDER="0"><BR>
				...
				<TR>
					...
					<TD WIDTH="655" VALIGN="TOP">
						<TABLE BORDER="0" CELLPADDING="4" CELLSPACING="1" WIDTH="100%">
							<TR>
								<TD WIDTH="16%" BGCOLOR="#0099FF" CLASS="tablehead">Title</TD>
								<TD WIDTH="16%" BGCOLOR="#0099FF" CLASS="tablehead">DOI</TD>
								<TD WIDTH="16%" BGCOLOR="#0099FF" CLASS="tablehead">Artist</TD>
								<TD WIDTH="16%" BGCOLOR="#0099FF" CLASS="tablehead">Owner</TD>
								<TD WIDTH="16%" BGCOLOR="#0099FF" CLASS="tablehead">Start Date</TD>
								<TD WIDTH="20%" BGCOLOR="#0099FF" CLASS="tablehead">End Date</TD>
							</TR>
							<TR>
								<TD WIDTH="16%"><IMG SRC="spacer.gif" WIDTH="6" HEIGHT="1" ALIGN="BOTTOM" BORDER="0"></TD>
								<TD WIDTH="16%"><IMG SRC="spacer.gif" WIDTH="6" HEIGHT="1" ALIGN="BOTTOM" BORDER="0"></TD>
								<TD WIDTH="16%"><IMG SRC="spacer.gif" WIDTH="6" HEIGHT="1" ALIGN="BOTTOM" BORDER="0"></TD>
								<TD WIDTH="16%"><IMG SRC="spacer.gif" WIDTH="6" HEIGHT="1" ALIGN="BOTTOM" BORDER="0"></TD>
								<TD WIDTH="16%"><IMG SRC="spacer.gif" WIDTH="6" HEIGHT="1" ALIGN="BOTTOM" BORDER="0"></TD>
								<TD WIDTH="20%"><IMG SRC="spacer.gif" WIDTH="6" HEIGHT="1" ALIGN="BOTTOM" BORDER="0"></TD>
							</TR>

<%	com.mutable.osms.server.bo.osmsIpmpAgreement[] agreements   = db.getIpmpAgreementByAssignedToUser(user.getUserId());%>
<%	for (int a=0;agreements!=null && a<agreements.length; a++){%>
<%		com.mutable.osms.server.bo.osmsContent       content     = db.getContentByContentId(agreements[a].getContentId());%>
<%		com.mutable.osms.server.bo.osmsDoi           contentDoi  = db.getDoiByDoiId( db.getContentDoiByContentId(content.getContentId()).getDoiId());%>
<%		com.mutable.osms.server.bo.osmsUsers         contentUser = db.getUsersByUserId(agreements[a].getRegisteredBy());%>
<%		com.mutable.osms.server.bo.osmsDigitalItem[] dgtlItms    = db.getDigitalItemByContentId(content.getContentId());%>


							<TR>
								<TD WIDTH="16%" BGCOLOR="#DDDDDD" CLASS="bodycopy"><%=content.getPrimaryTitle()%></TD>
								<TD WIDTH="16%" BGCOLOR="#DDDDDD" CLASS="bodycopy">
<NOBR>
									<P><%=contentDoi.getDoiIdentifier()%></NOBR>
								</TD>
								<TD WIDTH="16%" BGCOLOR="#DDDDDD" CLASS="bodycopy"><%=content.getPrimaryArtist()%></TD>
								<TD WIDTH="16%" BGCOLOR="#DDDDDD" CLASS="bodycopy"><%=contentUser.getUserName()%></TD>
								<TD WIDTH="16%" BGCOLOR="#DDDDDD" CLASS="bodycopy"><%=DateTool.convertToString(agreements[a].getStartDate())%></TD>
								<TD WIDTH="20%" BGCOLOR="#DDDDDD" CLASS="bodycopy"><%=DateTool.convertToString(agreements[a].getEndDate())%></TD>
							</TR>
<%}%>
						</TABLE>
<BR>
