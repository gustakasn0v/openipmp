	...
	<TR>
		...
		<TD VALIGN="TOP" COLSPAN="3" BGCOLOR="#FFFFFF">
			<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="686">
				<FORM METHOD=POST ACTION=licensedUsers_add.jsp>
					...
					<TR>
						...
						<TD WIDTH="655"><IMG SRC="licenses.gif" WIDTH="268" HEIGHT="23" ALIGN="BOTTOM" BORDER="0">
							<FONT CLASS="bodycopyitalic"> for <%= request.getParameter("primaryTitle")%> (<%= request.getParameter("doiIdentifier")%>)<BR>
					...
					<TR>
						...
						<TD WIDTH="655" VALIGN="TOP">
							<TABLE BORDER="0" CELLPADDING="4" CELLSPACING="1" WIDTH="100%">
								<TR>
									<TD WIDTH="16%" BGCOLOR="#0099FF" CLASS="tablehead">User</TD>
									<TD WIDTH="16%" BGCOLOR="#0099FF" CLASS="tablehead">Authorized Date</TD>
							...
							<% com.mutable.osms.server.bo.osmsIpmpAgreement[] agreements=db.getIpmpAgreementWithAssignedToOsmsUserByContentId(new Integer(request.getParameter("contentId")));%>
							<% for (int a=0;agreements!=null && a<agreements.length; a++) {%>

								<TR>
									<TD WIDTH="16%" BGCOLOR="#DDDDDD" CLASS="bodycopy"><%=agreements[a].getAssignedToOsmsUser().getUserName()%></TD>
									<TD WIDTH="16%" BGCOLOR="#DDDDDD" CLASS="bodycopy"><%=DateTool.convertToString(agreements[a].getCreatedOn())%></TD>
							...
							<TR>
								<TD>
									...
									<P>
										...
										<INPUT TYPE="SUBMIT" NAME="Submit" VALUE="Add User" style="font-size:10px">
									</DIV>
								</TD>
							</TR>
						</FORM>
