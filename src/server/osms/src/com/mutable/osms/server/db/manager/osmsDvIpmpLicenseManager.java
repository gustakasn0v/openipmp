...
import com.mutable.osms.server.db.manager.base.osmsDvIpmpLicenseManagerBase;

public class osmsDvIpmpLicenseManager extends osmsDvIpmpLicenseManagerBase implements Serializable
{
		...
		throws Exception
	{
		...
		bean.setLicenseId( seq);
		super.insert(bean,conn);
	}

	public osmsDvIpmpLicenseBean[] getByAgreementIdAndDigitalItemId(Integer pAgreementId,Integer pDigitalItemId,Connection conn)
		throws Exception
	{
