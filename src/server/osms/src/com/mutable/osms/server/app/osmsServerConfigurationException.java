...
/**
 * <p>Title: osmsServerConfigurationException </p>
...
public class osmsServerConfigurationException extends osmsException
{
	//Constructors
	public osmsServerConfigurationException(int p_ErrorCode, String p_Message)
	{
		super(p_ErrorCode, p_Message);
	}

	public osmsServerConfigurationException(int p_ErrorCode, String p_Message, String p_ErrorXmlTag)
	{
		super(p_ErrorCode, p_Message);
