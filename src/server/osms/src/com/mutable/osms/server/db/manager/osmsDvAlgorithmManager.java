...
public class osmsDvAlgorithmManager extends osmsDvAlgorithmManagerBase implements Serializable
{
...
/*
	...
	// INSERT
	//------------------------------------------------------------------
	public void insert(osmsDvAlgorithmBean bean,Connection conn)
		throws Exception
	{
		Integer seq = getNextSequence(conn);
		bean.setAlgorithmId( seq);
