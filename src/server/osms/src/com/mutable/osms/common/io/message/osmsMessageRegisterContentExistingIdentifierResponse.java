...
public class osmsMessageRegisterContentExistingIdentifierResponse extends osmsMessage
{
	//constructs
	public osmsMessageRegisterContentExistingIdentifierResponse()
	{
		super(osmsMessage.osmsMESSAGE_REGISTER_CONTENT_EXISTING_IDENTIFIER_RESPONSE);
	}
	//bean properties
