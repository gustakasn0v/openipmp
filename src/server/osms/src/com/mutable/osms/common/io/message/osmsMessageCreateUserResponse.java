...
/**
 * <p>Title: osmsMessageCreateUserResponse</p>
 * <p>Description: </p>
 * @version 1.0
 */

public class osmsMessageCreateUserResponse extends osmsMessage
{
	//constructs
	public osmsMessageCreateUserResponse()
	{
		super(osmsMessage.osmsMESSAGE_CREATE_USER_RESPONSE);
	}
