...
/**
 * <p>Title: osmsMessageUserLogoutResponse</p>
 * <p>Description: </p>
 * @version 1.0
 */

public class osmsMessageUserLogoutResponse extends osmsMessage
{
	//bean properties
	...
	//constructs
	public osmsMessageUserLogoutResponse()
	{
		super(osmsMessage.osmsMESSAGE_USER_LOGOUT_RESPONSE);
	}
}
