...
/**
 * <p>Title: osmsMessageRegisterContentAssignIdentifierRequest</p>
 * <p>Description: </p>
 * @version 1.0
 */

public class osmsMessageRegisterContentAssignIdentifierRequest extends osmsMessage
{
	//constructs
	public osmsMessageRegisterContentAssignIdentifierRequest ()
	{
		super(osmsMessage.osmsMESSAGE_REGISTER_CONTENT_ASSIGN_IDENTIFIER_REQUEST);
	}
