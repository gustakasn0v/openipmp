...
/**
 * <p>Title: osmsMessageRegisterContentAssignIdentifierResponse</p>
 * <p>Description: </p>
 * @version 1.0
 */

public class osmsMessageRegisterContentAssignIdentifierResponse extends osmsMessage
{
	//constructs
	public osmsMessageRegisterContentAssignIdentifierResponse()
	{
		super(osmsMessage.osmsMESSAGE_REGISTER_CONTENT_ASSIGN_IDENTIFIER_RESPONSE);
	}
