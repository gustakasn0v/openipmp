...
public class OsmsGetContentKeyRequest implements java.io.Serializable {
	...
	private String digitalItemInstanceId = null;
	
	public OsmsGetContentKeyRequest(String id, String type) {
		digitalItemInstanceId = id;
		metadataType = type;
	}
	...
	public String getDigitalItemInstanceId() {
		return digitalItemInstanceId;
	}

	public void setDigitalItemInstanceId(String digitalItemInstanceId) {
