...
public class  osmsDvIdentifierTypeBean  implements Serializable
{
	//-------------------------------------
	// properties
	//-------------------------------------
	...
	//-------------------------------------
	public void copyPropertiesTo (osmsDvIdentifierTypeBean target)
	{
...
/*
	...
	{
    	if (!(pObj instanceof osmsDvIdentifierTypeBean)) return false;
	    osmsDvIdentifierTypeBean obj = (osmsDvIdentifierTypeBean) pObj;
