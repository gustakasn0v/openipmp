...
public class osmsDvContentGridManagerBase implements Serializable
{
	private String m_tablename="CONTENT_GRID";
	...
	private String m_sqlResultSet=
		(
			(new StringBuffer())
			.append(" CONTENT_GRID.CONTENT_ID")
			.append(", ").append(" CONTENT_GRID.GRID_ID")
			.append(", ").append(" CONTENT_GRID.MAINTENANCE_FLAG")
			.append(", ").append(" CONTENT_GRID.LAST_UPDATED_BY")
			.append(", ").append(" CONTENT_GRID.LAST_UPDATED_ON")
			.append(", ").append(" CONTENT_GRID.CREATED_BY")
			.append(", ").append(" CONTENT_GRID.CREATED_ON")
		).toString();

/*
	private String m_sqlResultSet=" CONTENT_GRID.CONTENT_ID,  CONTENT_GRID.GRID_ID,  CONTENT_GRID.MAINTENANCE_FLAG,  CONTENT_GRID.LAST_UPDATED_BY,  CONTENT_GRID.LAST_UPDATED_ON,  CONTENT_GRID.CREATED_BY,  CONTENT_GRID.CREATED_ON";
*/
	//------------------------------------------------------------------
	// mapResultSet2Bean
	//------------------------------------------------------------------
	protected osmsDvContentGridBean mapResultSet2Bean(ResultSet rs)
		throws Exception
	{
			int i=1;

			osmsDvContentGridBean bean = new osmsDvContentGridBean();
...
/*
		...
		throws Exception
	{
		...
		osmsDvPkControlBean[] bean = managerPkControl.getByTableName("content_grid",conn);
...
*/
	...
	//------------------------------------------------------------------
	protected osmsDvContentGridBean[] executeQuery(PreparedStatement statement,Connection conn)
		throws Exception
	{
		ResultSet rs=null;
		osmsDvContentGridBean[] ret=null;
		try
		{
			...
			ret = new osmsDvContentGridBean[beans.size()];
			for(int i=0;i<beans.size();i++)
				ret[i]=(osmsDvContentGridBean)beans.elementAt(i);
	...
	// PROTECTED SELECT
	//------------------------------------------------------------------
	protected osmsDvContentGridBean[] get(Connection conn,String postWhere)
		throws Exception
	{
...
*/
	...
	protected osmsDvContentGridBean[] getByContentId(Integer pContentId,Connection conn,String postWhere)
		throws Exception
	{
		StringBuffer sql = new StringBuffer();
		sql.append("Select  ")
	...
	protected osmsDvContentGridBean[] getByGridId(Integer pGridId,Connection conn,String postWhere)
		throws Exception
	{
		StringBuffer sql = new StringBuffer();
		sql.append("Select  ")
	...
	// SELECT
	//------------------------------------------------------------------
	public osmsDvContentGridBean[] get(Connection conn)
		throws Exception
	{
		return get( conn,"");
	}

	public osmsDvContentGridBean[] getByContentId(Integer pContentId,Connection conn)
		throws Exception
	{
		return getByContentId( pContentId,conn,"");
	}

	public osmsDvContentGridBean[] getByGridId(Integer pGridId,Connection conn)
		throws Exception
	{
	...
	// UPDATE
	//------------------------------------------------------------------
	public synchronized void update(osmsDvContentGridBean bean,Connection conn)
		throws Exception
	{
	...
	// INSERT
	//------------------------------------------------------------------
	public void insert(osmsDvContentGridBean bean,Connection conn)
		throws Exception
	{
