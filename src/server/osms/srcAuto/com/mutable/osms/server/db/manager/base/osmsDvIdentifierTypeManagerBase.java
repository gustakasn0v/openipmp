...
public class osmsDvIdentifierTypeManagerBase implements Serializable
{
	private String m_tablename="IDENTIFIER_TYPE";
	...
	private String m_sqlResultSet=
		(
			(new StringBuffer())
			.append(" IDENTIFIER_TYPE.IDENTIFIER_TYPE_CODE")
			.append(", ").append(" IDENTIFIER_TYPE.DESCRIPTION")
			.append(", ").append(" IDENTIFIER_TYPE.MAINTENANCE_FLAG")
			.append(", ").append(" IDENTIFIER_TYPE.LAST_UPDATED_BY")
			.append(", ").append(" IDENTIFIER_TYPE.LAST_UPDATED_ON")
			.append(", ").append(" IDENTIFIER_TYPE.CREATED_BY")
			.append(", ").append(" IDENTIFIER_TYPE.CREATED_ON")
		).toString();

/*
	private String m_sqlResultSet=" IDENTIFIER_TYPE.IDENTIFIER_TYPE_CODE,  IDENTIFIER_TYPE.DESCRIPTION,  IDENTIFIER_TYPE.MAINTENANCE_FLAG,  IDENTIFIER_TYPE.LAST_UPDATED_BY,  IDENTIFIER_TYPE.LAST_UPDATED_ON,  IDENTIFIER_TYPE.CREATED_BY,  IDENTIFIER_TYPE.CREATED_ON";
*/
	//------------------------------------------------------------------
	// mapResultSet2Bean
	//------------------------------------------------------------------
	protected osmsDvIdentifierTypeBean mapResultSet2Bean(ResultSet rs)
		throws Exception
	{
			int i=1;

			osmsDvIdentifierTypeBean bean = new osmsDvIdentifierTypeBean();
			bean.setIdentifierTypeCode((String)ConvertObject2String(rs.getObject(i++)));
			bean.setDescription((String)ConvertObject2String(rs.getObject(i++)));
...
/*
		...
		throws Exception
	{
		...
		osmsDvPkControlBean[] bean = managerPkControl.getByTableName("identifier_type",conn);
...
*/
	...
	//------------------------------------------------------------------
	protected osmsDvIdentifierTypeBean[] executeQuery(PreparedStatement statement,Connection conn)
		throws Exception
	{
		ResultSet rs=null;
		osmsDvIdentifierTypeBean[] ret=null;
		try
		{
			...
			ret = new osmsDvIdentifierTypeBean[beans.size()];
			for(int i=0;i<beans.size();i++)
				ret[i]=(osmsDvIdentifierTypeBean)beans.elementAt(i);
	...
	// PROTECTED SELECT
	//------------------------------------------------------------------
	protected osmsDvIdentifierTypeBean[] get(Connection conn,String postWhere)
		throws Exception
	{
...
*/
	...
	protected osmsDvIdentifierTypeBean[] getByIdentifierTypeCode(String pIdentifierTypeCode,Connection conn,String postWhere)
		throws Exception
	{
		StringBuffer sql = new StringBuffer();
		sql.append("Select  ")
	...
	// SELECT
	//------------------------------------------------------------------
	public osmsDvIdentifierTypeBean[] get(Connection conn)
		throws Exception
	{
		return get( conn,"");
	}

	public osmsDvIdentifierTypeBean[] getByIdentifierTypeCode(String pIdentifierTypeCode,Connection conn)
		throws Exception
	{
	...
	// UPDATE
	//------------------------------------------------------------------
	public synchronized void update(osmsDvIdentifierTypeBean bean,Connection conn)
		throws Exception
	{
		...
		if(bean.getDescription()==null)statement.setNull(i++,java.sql.Types.VARCHAR); else statement.setObject(i++,bean.getDescription());
	...
	// INSERT
	//------------------------------------------------------------------
	public void insert(osmsDvIdentifierTypeBean bean,Connection conn)
		throws Exception
	{
