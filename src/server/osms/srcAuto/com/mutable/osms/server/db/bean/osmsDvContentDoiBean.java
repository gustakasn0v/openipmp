...
public class  osmsDvContentDoiBean  implements Serializable
{
	//-------------------------------------
	// properties
	//-------------------------------------
	...
	//-------------------------------------
	public void copyPropertiesTo (osmsDvContentDoiBean target)
	{
...
/*
	...
	{
    	if (!(pObj instanceof osmsDvContentDoiBean)) return false;
	    osmsDvContentDoiBean obj = (osmsDvContentDoiBean) pObj;
