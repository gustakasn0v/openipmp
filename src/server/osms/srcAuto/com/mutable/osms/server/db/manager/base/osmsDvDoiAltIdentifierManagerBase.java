...
public class osmsDvDoiAltIdentifierManagerBase implements Serializable
{
	private String m_tablename="DOI_ALT_IDENTIFIER";
	...
	private String m_sqlResultSet=
		(
			(new StringBuffer())
			.append(" DOI_ALT_IDENTIFIER.DOI_ID")
			.append(", ").append(" DOI_ALT_IDENTIFIER.ALT_IDENTIFIER_ID")
			.append(", ").append(" DOI_ALT_IDENTIFIER.SEQUENCE")
			.append(", ").append(" DOI_ALT_IDENTIFIER.MAINTENANCE_FLAG")
			.append(", ").append(" DOI_ALT_IDENTIFIER.LAST_UPDATED_BY")
			.append(", ").append(" DOI_ALT_IDENTIFIER.LAST_UPDATED_ON")
			.append(", ").append(" DOI_ALT_IDENTIFIER.CREATED_BY")
			.append(", ").append(" DOI_ALT_IDENTIFIER.CREATED_ON")
		).toString();

/*
	private String m_sqlResultSet=" DOI_ALT_IDENTIFIER.DOI_ID,  DOI_ALT_IDENTIFIER.ALT_IDENTIFIER_ID,  DOI_ALT_IDENTIFIER.SEQUENCE,  DOI_ALT_IDENTIFIER.MAINTENANCE_FLAG,  DOI_ALT_IDENTIFIER.LAST_UPDATED_BY,  DOI_ALT_IDENTIFIER.LAST_UPDATED_ON,  DOI_ALT_IDENTIFIER.CREATED_BY,  DOI_ALT_IDENTIFIER.CREATED_ON";
*/
	//------------------------------------------------------------------
	// mapResultSet2Bean
	//------------------------------------------------------------------
	protected osmsDvDoiAltIdentifierBean mapResultSet2Bean(ResultSet rs)
		throws Exception
	{
			int i=1;

			osmsDvDoiAltIdentifierBean bean = new osmsDvDoiAltIdentifierBean();
...
/*
		...
		throws Exception
	{
		...
		osmsDvPkControlBean[] bean = managerPkControl.getByTableName("doi_alt_identifier",conn);
...
*/
	...
	//------------------------------------------------------------------
	protected osmsDvDoiAltIdentifierBean[] executeQuery(PreparedStatement statement,Connection conn)
		throws Exception
	{
		ResultSet rs=null;
		osmsDvDoiAltIdentifierBean[] ret=null;
		try
		{
			...
			ret = new osmsDvDoiAltIdentifierBean[beans.size()];
			for(int i=0;i<beans.size();i++)
				ret[i]=(osmsDvDoiAltIdentifierBean)beans.elementAt(i);
	...
	// PROTECTED SELECT
	//------------------------------------------------------------------
	protected osmsDvDoiAltIdentifierBean[] get(Connection conn,String postWhere)
		throws Exception
	{
...
*/
	...
	protected osmsDvDoiAltIdentifierBean[] getByDoiIdAndAltIdentifierId(Integer pDoiId,Integer pAltIdentifierId,Connection conn,String postWhere)
		throws Exception
	{
		StringBuffer sql = new StringBuffer();
		sql.append("Select  ")
			...
			.append(" where ")
			.append(" DOI_ID = ? ")
			.append(" And ").append(" ALT_IDENTIFIER_ID = ? ")
	...
	protected osmsDvDoiAltIdentifierBean[] getByDoiId(Integer pDoiId,Connection conn,String postWhere)
		throws Exception
	{
		StringBuffer sql = new StringBuffer();
		sql.append("Select  ")
	...
	protected osmsDvDoiAltIdentifierBean[] getByAltIdentifierId(Integer pAltIdentifierId,Connection conn,String postWhere)
		throws Exception
	{
		StringBuffer sql = new StringBuffer();
		sql.append("Select  ")
	...
	// SELECT
	//------------------------------------------------------------------
	public osmsDvDoiAltIdentifierBean[] get(Connection conn)
		throws Exception
	{
		return get( conn,"");
	}

	public osmsDvDoiAltIdentifierBean[] getByDoiIdAndAltIdentifierId(Integer pDoiId,Integer pAltIdentifierId,Connection conn)
		throws Exception
	{
		return getByDoiIdAndAltIdentifierId( pDoiId, pAltIdentifierId,conn,"");
	}

	public osmsDvDoiAltIdentifierBean[] getByDoiId(Integer pDoiId,Connection conn)
		throws Exception
	{
		return getByDoiId( pDoiId,conn,"");
	}

	public osmsDvDoiAltIdentifierBean[] getByAltIdentifierId(Integer pAltIdentifierId,Connection conn)
		throws Exception
	{
	...
	// UPDATE
	//------------------------------------------------------------------
	public synchronized void update(osmsDvDoiAltIdentifierBean bean,Connection conn)
		throws Exception
	{
	...
	// INSERT
	//------------------------------------------------------------------
	public void insert(osmsDvDoiAltIdentifierBean bean,Connection conn)
		throws Exception
	{
