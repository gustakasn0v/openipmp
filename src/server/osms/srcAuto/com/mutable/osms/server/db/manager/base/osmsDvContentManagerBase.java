...
public class osmsDvContentManagerBase implements Serializable
{
	private String m_tablename="CONTENT";
	...
	private String m_sqlResultSet=
		(
			(new StringBuffer())
			.append(" CONTENT.CONTENT_ID")
			.append(", ").append(" CONTENT.IDENTIFIER_TYPE_CODE")
			.append(", ").append(" CONTENT.PRIMARY_IDENTIFIER")
			.append(", ").append(" CONTENT.PRIMARY_ARTIST")
			.append(", ").append(" CONTENT.PRIMARY_TITLE")
			.append(", ").append(" CONTENT.RELEASE_DATE")
			.append(", ").append(" CONTENT.LICENSE_BEGIN_DATE")
			.append(", ").append(" CONTENT.LICENSE_TYPE")
			.append(", ").append(" CONTENT.REGISTERED_BY")
			.append(", ").append(" CONTENT.MAINTENANCE_FLAG")
			.append(", ").append(" CONTENT.LAST_UPDATED_BY")
			.append(", ").append(" CONTENT.LAST_UPDATED_ON")
			.append(", ").append(" CONTENT.CREATED_BY")
			.append(", ").append(" CONTENT.CREATED_ON")
		).toString();

/*
	private String m_sqlResultSet=" CONTENT.CONTENT_ID,  CONTENT.IDENTIFIER_TYPE_CODE,  CONTENT.PRIMARY_IDENTIFIER,  CONTENT.PRIMARY_ARTIST,  CONTENT.PRIMARY_TITLE,  CONTENT.RELEASE_DATE,  CONTENT.LICENSE_BEGIN_DATE,  CONTENT.LICENSE_TYPE,  CONTENT.REGISTERED_BY,  CONTENT.MAINTENANCE_FLAG,  CONTENT.LAST_UPDATED_BY,  CONTENT.LAST_UPDATED_ON,  CONTENT.CREATED_BY,  CONTENT.CREATED_ON";
*/
	//------------------------------------------------------------------
	// mapResultSet2Bean
	//------------------------------------------------------------------
	protected osmsDvContentBean mapResultSet2Bean(ResultSet rs)
		throws Exception
	{
			int i=1;

			osmsDvContentBean bean = new osmsDvContentBean();
			...
			bean.setPrimaryIdentifier((String)ConvertObject2String(rs.getObject(i++)));
			...
			bean.setReleaseDate((Timestamp)ConvertObject2Timestamp(rs.getObject(i++)));
			bean.setLicenseBeginDate((Timestamp)ConvertObject2Timestamp(rs.getObject(i++)));
...
/*
		...
		throws Exception
	{
		...
		osmsDvPkControlBean[] bean = managerPkControl.getByTableName("content",conn);
...
*/
	...
	//------------------------------------------------------------------
	protected osmsDvContentBean[] executeQuery(PreparedStatement statement,Connection conn)
		throws Exception
	{
		ResultSet rs=null;
		osmsDvContentBean[] ret=null;
		try
		{
			...
			ret = new osmsDvContentBean[beans.size()];
			for(int i=0;i<beans.size();i++)
				ret[i]=(osmsDvContentBean)beans.elementAt(i);
	...
	// PROTECTED SELECT
	//------------------------------------------------------------------
	protected osmsDvContentBean[] get(Connection conn,String postWhere)
		throws Exception
	{
...
*/
	...
	protected osmsDvContentBean[] getByContentId(Integer pContentId,Connection conn,String postWhere)
		throws Exception
	{
		StringBuffer sql = new StringBuffer();
		sql.append("Select  ")
	...
	protected osmsDvContentBean[] getByPrimaryIdentifierAndIdentifierTypeCode(String pPrimaryIdentifier,String pIdentifierTypeCode,Connection conn,String postWhere)
		throws Exception
	{
		StringBuffer sql = new StringBuffer();
		sql.append("Select  ")
		...
		statement.setObject(i++,pPrimaryIdentifier);
		statement.setObject(i++,pIdentifierTypeCode);

		return executeQuery(statement,conn);
	}

	protected osmsDvContentBean[] getByRegisteredBy(Integer pRegisteredBy,Connection conn,String postWhere)
		throws Exception
	{
		StringBuffer sql = new StringBuffer();
		sql.append("Select  ")
	...
	protected osmsDvContentBean[] getByIdentifierTypeCode(String pIdentifierTypeCode,Connection conn,String postWhere)
		throws Exception
	{
		StringBuffer sql = new StringBuffer();
		sql.append("Select  ")
	...
	// SELECT
	//------------------------------------------------------------------
	public osmsDvContentBean[] get(Connection conn)
		throws Exception
	{
		return get( conn,"");
	}

	public osmsDvContentBean[] getByContentId(Integer pContentId,Connection conn)
		throws Exception
	{
		return getByContentId( pContentId,conn,"");
	}

	public osmsDvContentBean[] getByPrimaryIdentifierAndIdentifierTypeCode(String pPrimaryIdentifier,String pIdentifierTypeCode,Connection conn)
		throws Exception
	{
		return getByPrimaryIdentifierAndIdentifierTypeCode( pPrimaryIdentifier, pIdentifierTypeCode,conn,"");
	}

	public osmsDvContentBean[] getByRegisteredBy(Integer pRegisteredBy,Connection conn)
		throws Exception
	{
		return getByRegisteredBy( pRegisteredBy,conn,"");
	}

	public osmsDvContentBean[] getByIdentifierTypeCode(String pIdentifierTypeCode,Connection conn)
		throws Exception
	{
	...
	// UPDATE
	//------------------------------------------------------------------
	public synchronized void update(osmsDvContentBean bean,Connection conn)
		throws Exception
	{
		...
		.append("IDENTIFIER_TYPE_CODE = ? ")
			.append(", ").append("PRIMARY_IDENTIFIER = ? ")
			.append(", ").append("PRIMARY_ARTIST = ? ")
			.append(", ").append("PRIMARY_TITLE = ? ")
			.append(", ").append("RELEASE_DATE = ? ")
			.append(", ").append("LICENSE_BEGIN_DATE = ? ")
		...
		if(bean.getPrimaryIdentifier()==null)statement.setNull(i++,java.sql.Types.VARCHAR); else statement.setObject(i++,bean.getPrimaryIdentifier());
		...
		if(bean.getReleaseDate()==null)statement.setNull(i++,java.sql.Types.TIMESTAMP); else statement.setObject(i++,bean.getReleaseDate());
		if(bean.getLicenseBeginDate()==null)statement.setNull(i++,java.sql.Types.TIMESTAMP); else statement.setObject(i++,bean.getLicenseBeginDate());
	...
	// INSERT
	//------------------------------------------------------------------
	public void insert(osmsDvContentBean bean,Connection conn)
		throws Exception
	{
