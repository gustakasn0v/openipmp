...
public class osmsDvAlgorithmManagerBase implements Serializable
{
	private String m_tablename="ALGORITHM";
	...
	private String m_sqlResultSet=
		(
			...
			.append(", ").append(" ALGORITHM.NAME")
			.append(", ").append(" ALGORITHM.OBJECT_IDENTIFIER")
			.append(", ").append(" ALGORITHM.URL")
			.append(", ").append(" ALGORITHM.MAINTENANCE_FLAG")
			.append(", ").append(" ALGORITHM.LAST_UPDATED_BY")
			.append(", ").append(" ALGORITHM.LAST_UPDATED_ON")
			.append(", ").append(" ALGORITHM.CREATED_BY")
			.append(", ").append(" ALGORITHM.CREATED_ON")
		).toString();

/*
	private String m_sqlResultSet=" ALGORITHM.ALGORITHM_ID,  ALGORITHM.NAME,  ALGORITHM.OBJECT_IDENTIFIER,  ALGORITHM.URL,  ALGORITHM.MAINTENANCE_FLAG,  ALGORITHM.LAST_UPDATED_BY,  ALGORITHM.LAST_UPDATED_ON,  ALGORITHM.CREATED_BY,  ALGORITHM.CREATED_ON";
*/
	//------------------------------------------------------------------
	// mapResultSet2Bean
	//------------------------------------------------------------------
	protected osmsDvAlgorithmBean mapResultSet2Bean(ResultSet rs)
		throws Exception
	{
			int i=1;

			osmsDvAlgorithmBean bean = new osmsDvAlgorithmBean();
			bean.setAlgorithmId((Integer)ConvertObject2Integer(rs.getObject(i++)));
			bean.setName((String)ConvertObject2String(rs.getObject(i++)));
			bean.setObjectIdentifier((String)ConvertObject2String(rs.getObject(i++)));
...
/*
		...
		throws Exception
	{
		...
		osmsDvPkControlBean[] bean = managerPkControl.getByTableName("algorithm",conn);
...
*/
	...
	//------------------------------------------------------------------
	protected osmsDvAlgorithmBean[] executeQuery(PreparedStatement statement,Connection conn)
		throws Exception
	{
		ResultSet rs=null;
		osmsDvAlgorithmBean[] ret=null;
		try
		{
			...
			ret = new osmsDvAlgorithmBean[beans.size()];
			for(int i=0;i<beans.size();i++)
				ret[i]=(osmsDvAlgorithmBean)beans.elementAt(i);
	...
	// PROTECTED SELECT
	//------------------------------------------------------------------
	protected osmsDvAlgorithmBean[] get(Connection conn,String postWhere)
		throws Exception
	{
...
*/
	...
	protected osmsDvAlgorithmBean[] getByAlgorithmId(Integer pAlgorithmId,Connection conn,String postWhere)
		throws Exception
	{
		StringBuffer sql = new StringBuffer();
		sql.append("Select  ")
	...
	protected osmsDvAlgorithmBean[] getByObjectIdentifier(String pObjectIdentifier,Connection conn,String postWhere)
		throws Exception
	{
		StringBuffer sql = new StringBuffer();
		sql.append("Select  ")
		...
		statement.setObject(i++,pObjectIdentifier);
	...
	// SELECT
	//------------------------------------------------------------------
	public osmsDvAlgorithmBean[] get(Connection conn)
		throws Exception
	{
		return get( conn,"");
	}

	public osmsDvAlgorithmBean[] getByAlgorithmId(Integer pAlgorithmId,Connection conn)
		throws Exception
	{
		return getByAlgorithmId( pAlgorithmId,conn,"");
	}

	public osmsDvAlgorithmBean[] getByObjectIdentifier(String pObjectIdentifier,Connection conn)
		throws Exception
	{
		return getByObjectIdentifier( pObjectIdentifier,conn,"");
	}
	...
	// UPDATE
	//------------------------------------------------------------------
	public synchronized void update(osmsDvAlgorithmBean bean,Connection conn)
		throws Exception
	{
		...
		.append("NAME = ? ")
			.append(", ").append("OBJECT_IDENTIFIER = ? ")
			.append(", ").append("URL = ? ")
		...
		if(bean.getName()==null)statement.setNull(i++,java.sql.Types.VARCHAR); else statement.setObject(i++,bean.getName());
		if(bean.getObjectIdentifier()==null)statement.setNull(i++,java.sql.Types.VARCHAR); else statement.setObject(i++,bean.getObjectIdentifier());
