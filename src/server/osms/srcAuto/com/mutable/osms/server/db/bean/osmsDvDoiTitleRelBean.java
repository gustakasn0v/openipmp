...
public class  osmsDvDoiTitleRelBean  implements Serializable
{
	//-------------------------------------
	// properties
	//-------------------------------------
	...
	//-------------------------------------
	public void copyPropertiesTo (osmsDvDoiTitleRelBean target)
	{
...
/*
	...
	{
    	if (!(pObj instanceof osmsDvDoiTitleRelBean)) return false;
	    osmsDvDoiTitleRelBean obj = (osmsDvDoiTitleRelBean) pObj;
