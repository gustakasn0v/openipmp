 ...
 *
 * @version $Id: ISignSession.java,v 1.2 2006/06/12 15:53:09 danijel Exp $
 */
public interface ISignSession {
    ...
    */
	...
	/** Verify the authenticity of a SHA1 digest that has been previously signed with the CA's Private Key against the
	*   original series of bytes.
	*
	...
	*/
    ...
    /** Generates a SHA1 Digest off of a byte[] and signs resulting digest with the CA's Private Key.
    *
    *  @param byte[] p_Bytes - the series of bytes to be hashed and signed
    *  @returns byte[] p_SignedDigest - the signed digest.
    */
    public byte[] generateSignedSHA1Digest(byte p_Bytes[]) throws RemoteException;
}
