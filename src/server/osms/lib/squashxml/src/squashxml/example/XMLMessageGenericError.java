...
public class XMLMessageGenericError extends XMLMessageExampleBase
{
	// Constructor
	public XMLMessageGenericError()
	{
		super(XMLMessageExampleBase.GENERIC_ERROR);
	}
	...
	public void setErrorString(String eStr)
	{
		errorString = eStr;
	}
}
