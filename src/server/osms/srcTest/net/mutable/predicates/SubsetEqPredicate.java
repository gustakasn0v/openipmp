...
public class SubsetEqPredicate extends Predicate {
	private Expression lhs;
	private Expression rhs;
	
	public SubsetEqPredicate(Expression lhs, Expression rhs){
		this.lhs = lhs;
		this.rhs = rhs;
	}

	public boolean eval(Map val) throws Exception {
		return ((Set)lhs.eval(val)).subseteq((Set)rhs.eval(val));
	}
