...
-- *** 
INSERT INTO CERTIFICATE ( CERTIFICATE_ID, CA_CERTIFICATE_ID,  CERTIFICATE_TYPE_CODE, VERSION, NOT_VALID_AFTER_DT, ENCRYPTION_KEY_ID, ALGORITHM_ID,  REVOCATION_ID, ACTION_CODE, STATUS_FLAG, MAINTENANCE_FLAG, LAST_UPDATED_BY,   SERIAL_NUM, CREATED_BY, NOT_VALID_BEFORE_DT) VALUES (   1, 1, 'CA', 3, STR_TO_DATE('01/01/2005 00:00:00', '%d/%m/%Y %H:%i:%s'), 1, 2, NULL, NULL, NULL, NULL,   'OSMSLOAD', 'A', 'OSMSLOAD', STR_TO_DATE('01/01/2003 00:00:00','%d/%m/%Y %H:%i:%s'));
