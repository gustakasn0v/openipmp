...
GRANT ALL PRIVILEGES ON OSMS.* TO ''@"%" WITH GRANT OPTION;
GRANT SHOW DATABASES ON *.* TO osms@localhost; 
GRANT SHOW DATABASES ON *.* TO osms@127.0.0.1;
GRANT SHOW DATABASES ON *.* TO osms@"%";
