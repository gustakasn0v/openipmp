...
/**
 * abstract functionality of an object which can externalize as a stand-alone
 * xml document
 * 
 * 
 *
...
public abstract class XmlDocument implements IXmlDocument {
	...
	public abstract void setDomElement(IElement elem);
	
	public IDocument asDomDocument() {
		FactoryHelper fact = new FactoryHelper();
		IDocument doc =  fact.createDocument(documentName());
