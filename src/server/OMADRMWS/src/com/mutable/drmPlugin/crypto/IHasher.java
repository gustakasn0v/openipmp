...
/**
 * Utility  for SHA-1 message digests.
 * 
 * 
 *
 */
public interface IHasher  {
	...
	/**
	 * @return base64 encoded SHA-1 digest of the input
	 */

	public Base64String hash(String data);
	
	/**
	 * @return  key identifier according to "http://www.w3.org/2000/09/xmldsig#sha1"
	 */
