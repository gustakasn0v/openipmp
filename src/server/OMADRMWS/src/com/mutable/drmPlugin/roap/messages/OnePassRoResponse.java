 ...
 * 1-pass  Roap rights acquisition protocol
 * 
 * not really used in current server implementation
 * 
 * 
 *
 */

public class OnePassRoResponse extends SuccessRoResponseAbstract {


	public OnePassRoResponse(SuccessStatus status, RoapIdentifier did,
