...
public class CanonicalizationMethod extends XmlChild {
	...
	public CanonicalizationMethod(UriValue algorithm) {
		super();
	...
	public CanonicalizationMethod() {
		this(new UriValue("http://www.w3.org./2001/10/xml-exc-c14n#"));
	}
	...
	public String domName() { return "CanonicalizationMethod"; }
