...
public class FailureRegistrationResponse extends RegistrationResponse {
	

	public FailureRegistrationResponse(FailureStatus status, SessionId id) {
		super(status);
		sessionId = id;
	}


	public FailureRegistrationResponse(Status status) {
		super(status);
	}
