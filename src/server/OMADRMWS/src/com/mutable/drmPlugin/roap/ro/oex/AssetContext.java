...
public class AssetContext extends Context {
	 ...
	 */
	public AssetContext(AssetUid uid) {
		super(null, new Uids(uid));
	}
	
	public static AssetContext instanceFromDomElement(IElement elem) {
		Uids uids = Uids.instanceFromDomElement(elem);
		return new AssetContext((AssetUid)uids.getData().firstElement());
	}
