 ...
 * 
 */
#ifndef OSMS_Message_Login_Response_H
#define OSMS_Message_Login_Response_H

#include "osmsMessage.h"

class osmsMessageLoginResponse : public osmsMessage
{
public:
	osmsMessageLoginResponse();
	virtual ~osmsMessageLoginResponse();
