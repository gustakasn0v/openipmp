...
osmsMessageRegisterUserResponseError::osmsMessageRegisterUserResponseError()
	: osmsMessageGenericResponseError(osmsMessage::osmsMESSAGE_REGISTER_USER_RESPONSE_ERROR, "com.mutable.osms.common.io.message.osmsMessageRegisterUserResponseError")
{
}


char* osmsMessageRegisterUserResponseError::xmlTemplate()
{
	return
		"<?xml version=\"1.0\"?>" \
		"<com.mutable.osms.common.io.message.osmsMessageRegisterUserResponseError>" \
...
char* osmsMessageRegisterUserResponseError::encode()
{
...
bool osmsMessageRegisterUserResponseError::decode(char* xmlText)
{
	XMLDocument* pDoc = new XMLDocument();
	if (pDoc == NULL)
		return false;
