...
osmsMessageUserLogoutResponseError::osmsMessageUserLogoutResponseError()
	: osmsMessageGenericResponseError(osmsMessage::osmsMESSAGE_USER_LOGOUT_RESPONSE_ERROR, "com.mutable.osms.common.io.message.osmsMessageUserLogoutResponseError")
{
}

char* osmsMessageUserLogoutResponseError::xmlTemplate()
{
	return
		"<?xml version=\"1.0\"?>" \
		"<com.mutable.osms.common.io.message.osmsMessageUserLogoutResponseError>" \
...
char* osmsMessageUserLogoutResponseError::encode()
{
...
bool osmsMessageUserLogoutResponseError::decode(char* xmlText)
{
	XMLDocument* pDoc = new XMLDocument();
	if (pDoc == NULL)
		return false;
