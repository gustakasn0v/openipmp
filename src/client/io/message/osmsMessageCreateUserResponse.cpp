...
osmsMessageCreateUserResponse::osmsMessageCreateUserResponse()
	: osmsMessage(osmsMessage::osmsMESSAGE_CREATE_USER_RESPONSE, "com.mutable.osms.common.io.message.osmsMessageCreateUserResponse")
{
...
char* osmsMessageCreateUserResponse::xmlTemplate()
{
	return
		"<?xml version=\"1.0\"?>" \
		"<com.mutable.osms.common.io.message.osmsMessageCreateUserResponse>" \
			"<MessageType type=\"int\"></MessageType>" \
			"<ResponseString type=\"char[]\"></ResponseString>" \
		"</com.mutable.osms.common.io.message.osmsMessageCreateUserResponse>";
}

char* osmsMessageCreateUserResponse::encode()
{
...
bool osmsMessageCreateUserResponse::decode(char* xmlText)
{
	XMLDocument* pDoc = new XMLDocument();
	if (pDoc == NULL)
		return false;
...
//bean properties
char* osmsMessageCreateUserResponse::getResponseString()
{
	return m_ResponseString;
}
void osmsMessageCreateUserResponse::setResponseString(char* ResponseString)
{
	if (m_ResponseString != NULL)
	{
		delete[] m_ResponseString;
