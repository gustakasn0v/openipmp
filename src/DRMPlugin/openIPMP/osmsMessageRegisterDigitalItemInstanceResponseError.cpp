...
osmsMessageRegisterDigitalItemInstanceResponseError::osmsMessageRegisterDigitalItemInstanceResponseError()
	: osmsMessageGenericResponseError(osmsMessage::osmsMESSAGE_REGISTER_DIGITAL_ITEM_INSTANCE_RESPONSE_ERROR, "com.mutable.osms.common.io.message.osmsMessageRegisterDigitalItemInstanceResponseError")
{
}

char* osmsMessageRegisterDigitalItemInstanceResponseError::xmlTemplate()
{
	return
		"<?xml version=\"1.0\"?>" \
		"<com.mutable.osms.common.io.message.osmsMessageRegisterDigitalItemInstanceResponseError>" \
