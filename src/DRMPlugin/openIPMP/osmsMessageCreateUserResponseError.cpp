...
osmsMessageCreateUserResponseError::osmsMessageCreateUserResponseError()
	: osmsMessageGenericResponseError(osmsMessage::osmsMESSAGE_CREATE_USER_RESPONSE_ERROR, "com.mutable.osms.common.io.message.osmsMessageCreateUserResponseError")
{
}


char* osmsMessageCreateUserResponseError::xmlTemplate()
{
	return
		"<?xml version=\"1.0\"?>" \
		"<com.mutable.osms.common.io.message.osmsMessageCreateUserResponseError>" \
...
char* osmsMessageCreateUserResponseError::encode()
{
...
bool osmsMessageCreateUserResponseError::decode(char* xmlText)
{
	XMLDocument* pDoc = new XMLDocument();
	if (pDoc == NULL)
		return false;
