...
osmsMessageLicenseResponseError::osmsMessageLicenseResponseError()
	: osmsMessageGenericResponseError(osmsMessage::osmsMESSAGE_LICENSE_RESPONSE_ERROR, "com.mutable.osms.common.io.message.osmsMessageLicenseResponseError")
{
}



char* osmsMessageLicenseResponseError::xmlTemplate()
{
	return
		"<?xml version=\"1.0\"?>" \
		"<com.mutable.osms.common.io.message.osmsMessageLicenseResponseError>" \
...
char* osmsMessageLicenseResponseError::encode()
{
...
bool osmsMessageLicenseResponseError::decode(char* xmlText)
{
	XMLDocument* pDoc = new XMLDocument();
	if (pDoc == NULL)
		return false;
