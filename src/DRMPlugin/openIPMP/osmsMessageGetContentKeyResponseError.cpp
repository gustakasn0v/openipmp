...
osmsMessageGetContentKeyResponseError::osmsMessageGetContentKeyResponseError()
	: osmsMessageGenericResponseError(osmsMessage::osmsMESSAGE_GET_CONTENT_KEY_RESPONSE_ERROR, "com.mutable.osms.common.io.message.osmsMessageGetContentKeyResponseError")
{
}


char* osmsMessageGetContentKeyResponseError::xmlTemplate()
{
	return
		"<?xml version=\"1.0\"?>" \
		"<com.mutable.osms.common.io.message.osmsMessageGetContentKeyResponseError>" \
...
char* osmsMessageGetContentKeyResponseError::encode()
{
...
bool osmsMessageGetContentKeyResponseError::decode(char* xmlText)
{
	XMLDocument* pDoc = new XMLDocument();
	if (pDoc == NULL)
		return false;
