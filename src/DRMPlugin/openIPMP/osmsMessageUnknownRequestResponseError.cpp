...
osmsMessageUnknownRequestResponseError::osmsMessageUnknownRequestResponseError()
	: osmsMessageGenericResponseError(osmsMessage::osmsMESSAGE_UNKNOWN_REQUEST_RESPONSE_ERROR, "com.mutable.osms.common.io.message.osmsMessageUnknownRequestResponseError")
{
}



char* osmsMessageUnknownRequestResponseError::xmlTemplate()
{
	return
		"<?xml version=\"1.0\"?>" \
		"<com.mutable.osms.common.io.message.osmsMessageUnknownRequestResponseError>" \
...
char* osmsMessageUnknownRequestResponseError::encode()
{
...
bool osmsMessageUnknownRequestResponseError::decode(char* xmlText)
{
	XMLDocument* pDoc = new XMLDocument();
	if (pDoc == NULL)
		return false;
