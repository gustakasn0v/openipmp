...
osmsMessageUserLoginResponseError::osmsMessageUserLoginResponseError()
	: osmsMessageGenericResponseError(osmsMessage::osmsMESSAGE_USER_LOGIN_RESPONSE_ERROR, "com.mutable.osms.common.io.message.osmsMessageUserLoginResponseError")
{
}


char* osmsMessageUserLoginResponseError::xmlTemplate()
{
	return
		"<?xml version=\"1.0\"?>" \
		"<com.mutable.osms.common.io.message.osmsMessageUserLoginResponseError>" \
...
char* osmsMessageUserLoginResponseError::encode()
{
...
bool osmsMessageUserLoginResponseError::decode(char* xmlText)
{
	XMLDocument* pDoc = new XMLDocument();
	if (pDoc == NULL)
		return false;
