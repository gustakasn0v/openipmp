/**	\file OpenIPMPOMADRMEncManager.cpp
...
*/
OpenIPMPOMADRMEncManager::OpenIPMPOMADRMEncManager(IXMLElement* xml, DRMLogger& logger):
  manager(new OpenIPMPKeyManager(xml, logger)), managerLogger(logger) {
}

OpenIPMPOMADRMEncManager::~OpenIPMPOMADRMEncManager() {
...
*/
BlowfishEncryptor* OpenIPMPOMADRMEncManager::CreateBlowfishEnc(std::string& contentID,
    IXMLElement* xmlDoc) {
...
/*! \brief  Create AES128CBC encryptor.
    ...
    \returns  If successful, newly created encryptor. If failed, zero pointer.
*/
AES128CBCEncryptor* OpenIPMPOMADRMEncManager::CreateAES128CBCEnc(std::string& contentID,
    IXMLElement* xmlDoc) {
...
/*! \brief  Create AES128CTR encryptor.
    ...
    \returns  If successful, newly created encryptor. If failed, zero pointer.
*/
AES128CTREncryptor* OpenIPMPOMADRMEncManager::CreateAES128CTREnc(std::string& contentID,
    IXMLElement* xmlDoc) {
...
/*! \brief  Create AES128ICM encryptor.
    ...
    \returns  If successful, newly created encryptor. If failed, zero pointer.
*/
AES128ICMEncryptor* OpenIPMPOMADRMEncManager::CreateAES128ICMEnc(std::string& contentID,
    IXMLElement* xmlDoc) {
...
*/
bool OpenIPMPOMADRMEncManager::AddLicense(std::string& contentID, IXMLElement* xmlDoc) {
