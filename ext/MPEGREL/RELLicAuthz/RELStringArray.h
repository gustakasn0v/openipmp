// RELStringArray.h: interface for the CRELStringArray class.
//
//////////////////////////////////////////////////////////////////////
...
#if !defined(AFX_RELSTRINGARRAY_H__DD403E6E_E7B2_4775_93D7_E714297555B4__INCLUDED_)
#define AFX_RELSTRINGARRAY_H__DD403E6E_E7B2_4775_93D7_E714297555B4__INCLUDED_
...
class RELLICAUTHZ_API CRELStringArray  
{
public:

	//------------------------------------------------------------------------------------------
	//--FUNCTION CRELStringArray
	//------------------------------------------------------------------------------------------
	//--This is the constructor of the exported class CRELStringArray.
	//------------------------------------------------------------------------------------------
	CRELStringArray();
	...
	//--FUNCTION ~CRELStringArray
	//------------------------------------------------------------------------------------------
	//--This is the destructor of the exported class CRELStringArray.
	//------------------------------------------------------------------------------------------
	virtual ~CRELStringArray();

	//------------------------------------------------------------------------------------------
	//--FUNCTION item
	//------------------------------------------------------------------------------------------
	//--This function returns the String in index nPos in the array
	//--Parameters:
	//		int nPos							->The index of the return string
	//------------------------------------------------------------------------------------------
	CComBSTR item(int nPos);
	...
	//--Parameters:
	//		CComBSTR bstrItem					->The string to be added to the array
	//------------------------------------------------------------------------------------------
	HRESULT addItem(CComBSTR bstrItem);

	//------------------------------------------------------------------------------------------
	//--FUNCTION clearItems
	//------------------------------------------------------------------------------------------
	//--This function clears all the items in the array
	//------------------------------------------------------------------------------------------
	void clearItems();
	...
	//		int nPos							->The index of the return string
	//------------------------------------------------------------------------------------------
	inline CComBSTR operator [] (int nPos)
	{
		return item(nPos);
	}
	...
	//--FUNCTION Release
	//------------------------------------------------------------------------------------------
	//--This function releases the 'this' pointer.
	//------------------------------------------------------------------------------------------
	void Release();

private:
	CComBSTR *m_bstrBuffer;  // The buffer to hold the array
	int m_nCount;			 // The size of the array
	int m_nBufferLength;	 // The total length of the buffer
	int m_nIncrementLength;	 // The length by which the buffer will increase every time

};

#endif // !defined(AFX_RELSTRINGARRAY_H__DD403E6E_E7B2_4775_93D7_E714297555B4__INCLUDED_)
