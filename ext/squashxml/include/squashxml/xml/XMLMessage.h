...
class XMLMessage : public MessageContainer
{
public:
    XMLMessage();
    XMLMessage(XMLMessageBean* bean);

    XMLMessageBean* getBean();
    void setBean(XMLMessageBean* bean);

	static void registerApplicationMessageBean(XMLMessageBean* applicationBean);
