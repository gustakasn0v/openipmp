...
#ifndef DataTypeByteArray_H
#define DataTypeByteArray_H

#include "squashxml/tools/ByteArray.h"
#include "squashxml/xml/datatype/DataTypeBinaryHex.h"
#include "squashxml/xml/datatype/DataTypeCodex.h"

#include "squashxml/tools/FileLogger.h"


class DataTypeByteArray : public DataTypeBinaryHex
{
public:
