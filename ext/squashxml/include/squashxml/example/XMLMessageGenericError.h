...
#ifndef XMLMessageGenericError_H
#define XMLMessageGenericError_H

#include "squashxml/xml/XMLMessageBean.h"
#include "squashxml/example/XMLMessageExampleBase.h"

class XMLMessageGenericError : public XMLMessageExampleBase
{
public:
	XMLMessageGenericError();
	virtual ~XMLMessageGenericError();
	...
	//bean properties
	char* getErrorString();
	void setErrorString(char* errorString);

private:
	char* m_ErrorString;
};

#endif // XMLMessageGenericError_H
