...
public:
	...
	virtual bool logInfo(const char* str);
	virtual bool logDebug(const char* str);
	virtual bool logWarning(const char* str);
	virtual bool logError(const char* str);

private:
	char* getDateTime();
	char m_TempStr[32*1024];
