...
XMLMessageBean::XMLMessageBean(int messageType, const char* name)
{
	m_messageType = messageType;
	m_Name = name;
}

XMLMessageBean::~XMLMessageBean()
{
}

const char* XMLMessageBean::getName()
{
	return m_Name;
}
...
// Bean methods
void XMLMessageBean::setMessageType(int mType)
{
	// only in constructor
}

int XMLMessageBean::getMessageType()
{
